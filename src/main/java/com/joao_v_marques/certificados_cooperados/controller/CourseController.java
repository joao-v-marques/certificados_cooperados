...
public class CourseController {
    ...
    public ResponseEntity<CourseResponse> create(@Valid @ModelAttribute CourseRequest request, @RequestPart("certificate") MultipartFile certificate) {
        // TODO: trocar pelo id do Authentication quando o login existir
